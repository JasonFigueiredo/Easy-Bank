                    ...
                    <div class="form-card">
                        <form action="alterar_empresas.php" method="post" class="user-form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success" name="btn_salvar" onclick="return CadastrarEmpresa()">
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button type="button" data-toggle="modal" data-target="#modalExcluir" class="btn btn-danger">
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
